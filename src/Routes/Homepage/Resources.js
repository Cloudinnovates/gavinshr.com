...
export default function Resources() {
  return (
    ...
    <div className="container subscreen-container">
      ...
      <ul style={{ paddingTop: "15px", paddingLeft: "20px", paddingRight: "20px" }}>
        ...
        <li><a className="link" href="https://snipcart.com/blog/spa-seo" target="_blank" rel="noopener noreferrer">SPA SEO - Single Page App Guide For Search Engine Optimization</a></li>
        <li><a className="link" href="https://github.com/stereobooster/react-snap" target="_blank" rel="noopener noreferrer">React Pre-Rendering Library Used To Automatically Generate Server Side Pre-Rendering For SEO</a></li>
      </ul>
